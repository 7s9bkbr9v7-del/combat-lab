 ...
 *
 * <p>Version probing, reflection, or module lookups should happen before updating this switch. Hot
 * paths should only call {@link #enabled()}, which is just a volatile boolean read.
 */
