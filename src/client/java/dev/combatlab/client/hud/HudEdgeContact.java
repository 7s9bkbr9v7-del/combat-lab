...
/**
 * Describes whether a normalized HUD module position is snapped to the screen perimeter. Adaptive
 * modules can use this to choose compact edge layouts without duplicating floating-point edge
 * checks.
 */
