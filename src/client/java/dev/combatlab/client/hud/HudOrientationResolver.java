...
public final class HudOrientationResolver {
  ...
  public static HudOrientation resolve(HudRectangle module, int screenWidth, int screenHeight) {
    ...
    HudHorizontalSide horizontalSide =
        module.centerX() <= centerX ? HudHorizontalSide.RIGHT : HudHorizontalSide.LEFT;
    HudVerticalSide verticalSide =
        module.centerY() <= centerY ? HudVerticalSide.BOTTOM : HudVerticalSide.TOP;
