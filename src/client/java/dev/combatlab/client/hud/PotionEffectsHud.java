...
public final class PotionEffectsHud extends ResizableBaseHudModule {
	...
	public static HudModuleDescriptor descriptor() {
		return new HudModuleDescriptor(DEFINITION, dependencies -> new PotionEffectsHud(dependencies.options(), dependencies.debug()));
	}
	...
	private void renderEffect(GuiGraphicsExtractor graphics, Font font, PlayerEffectTimer effect, int y) {
		...
		graphics.blit(RenderPipelines.GUI_TEXTURED, effect.iconTexture(), PADDING, y + 2, 0.0F, 0.0F, ICON_SIZE, ICON_SIZE, ICON_SIZE, ICON_SIZE);
