...
public final class HudEditorModuleActions {
	...
	public HudEditorModuleActions(HudModuleRegistry modules, HudSelection selection, int addSnapThreshold) {
	...
	public void enableAt(String id, int requestedX, int requestedY, int screenWidth, int screenHeight) {
		...
		HudPosition snapped = HudSnapper.snapToEdges(
		...
		HudRectangle snappedRectangle = new HudRectangle(snapped.x(), snapped.y(), size.width(), size.height());
