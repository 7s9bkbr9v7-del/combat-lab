...
public final class HudModuleSelection {
	...
	public void select(HudModule module, boolean addToSelection, boolean rangeSelect, List<HudModule> modules) {
	...
	public void selectWithin(HudRectangle selectionBounds, List<HudSelection.ModuleRectangle> modules, boolean addToSelection) {
		if (!addToSelection) {
			selectedIds.clear();
		}
	...
	private static List<String> attachmentPath(String firstId, String secondId, List<HudModule> modules) {
