...
class ArmorHudLayoutTest {
	...
	void keepsThePreviousLayoutAwayFromScreenEdges() {
		assertEquals(
				ArmorHudLayout.VERTICAL,
				ArmorHudLayout.resolve(0.5, 0.5, ArmorHudLayout.VERTICAL)
		);
		assertEquals(
				ArmorHudLayout.HORIZONTAL,
				ArmorHudLayout.resolve(0.5, 0.5, ArmorHudLayout.HORIZONTAL)
		);
	}
