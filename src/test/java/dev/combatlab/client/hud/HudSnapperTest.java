...
class HudSnapperTest {
	...
	void snapsToNearestGridLineWithinScreenBounds() {
		HudPosition snapped = HudSnapper.snapToGrid(
				new HudRectangle(13, 18, 20, 10),
				4,
				100,
				80
		);
	...
	void createsGuideForScreenCenterAlignment() {
		HudSnapResult result = HudSnapper.snapWithGuides(
				new HudRectangle(121, 30, 60, 20),
				List.of(),
				6,
				300,
				200
	...
	void createsBothGuidesForScreenCenterAlignment() {
		List<HudSnapGuide> guides = HudSnapper.guidesForAlignment(
	...
	void keepsDistantGuideWhenAlsoAdjacentToAnotherModule() {
		List<HudSnapGuide> guides = HudSnapper.guidesForAlignment(
				...
				List.of(
						new HudRectangle(100, 100, 80, 20),
						new HudRectangle(160, 180, 80, 20)
				),
				6,
				300,
				400
